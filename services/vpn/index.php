...
<div class="page">
    <div class="page__banner">
        <? component("banner", array(
            "picture" => array(
                "desctop" => "/images/content/banner/vpn.png",
                "mobile" => "/images/content/banner/vpn-mobile.png"
            ),
            "bread" => array(
                array(
                    "name" => "Услуги",
    ...
    <div class="page__section">
        ...
        <ul>
            <li>Организация виртуальной частной сети заказчика, включая техническую поддержку и обслуживание. Предоставляем как единичные выделенные каналы передачи данных между двумя офисами, так и мощные корпоративные сети с десятками точек VPN на базе сети MPLS.</li>
