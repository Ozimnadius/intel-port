...
<div class="page">
    <div class="page__banner">
        <? component("banner", array(
            "picture" => array(
                "desctop" => "/images/content/banner/cctv.png",
                "mobile" => "/images/content/banner/cctv-mobile.png"
            ),
            "bread" => array(
                array(
                    "name" => "Услуги",
            ...
            "content" => "<p>Проектирование, создание и обслуживание <br> систем видеонаблюдения</p>"
        )) ?>
    </div>
                    ...
                    <div class="internet-about__grid internet-about__grid--center">
                        <div class="internet-about__left">
                            <div class="internet-about__img">
                                <img src="/images/content/internet/about/cctv.jpg">
                            </div>
                        </div>
                        <div class="internet-about__right">
                            <div class="internet-about__content">
                                <h3>Видеонаблюдение</h3>
                                <p>Благодаря организованному нами программно-аппаратному <br>
                                    решению осуществляется мониторинг порядка <br>
                                    в общественных местах и различных объектах <br>
                                    для нужд администрации Троицка (Новая Москва).</p>
                            </div>
                        </div>
                    </div>
                </div>
