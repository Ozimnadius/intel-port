...
<div class="page">
    <div class="page__banner">
        <? component("banner", array(
            "picture" => array(
                "desctop" => "/images/content/banner/phones.png",
                "mobile" => "/images/content/banner/phones-mobile.png"
            ),
            "bread" => array(
                array(
                    "name" => "Услуги",
                ...
                array(
                    "name" => "Проектирование и строительство сетей"
                )
            ),
            "title" => "Проектирование <br> и строительство сетей",
            "content" => "<p>Комплекс услуг по проектированию и <br> строительству сетей</p>"
        )) ?>
    </div>
    <div class="page__section">
        <? component("networks-about") ?>
    </div>
    <div class="page__section">
