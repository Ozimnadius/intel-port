<div class="policy">
    <div class="container">
        <div class="container-inner policy__container">
                ...
                <ol>
                    ...
                    <li>Основные понятия, используемые в Политике
                        <ol>
                            ...
                            <li>Пользователь – любой посетитель веб-сайта httpsː//thismywebsite·com.</li>
                            <li>
                    ...
                    <li>Основные права и обязанности субъектов <br> персональных данных
                        <ol>
                            <li>Основные права и обязанности субъектов персональных данных
                                <ul>
                                    <li>
                                        ...
                                        таких персональных данных. Перечень информации и порядок ее получения установлен
