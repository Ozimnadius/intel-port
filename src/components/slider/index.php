<? $list = array(
    array(
        "img" => "/images/content/slider/1.jpg",
        "imgTablet" => "/images/content/slider/1-tablet.jpg",
        "imgMobile" => "/images/content/slider/-mobile.jpg",
        "title" => "2013",
        "sub" => "Год основания",
        "txt" => "Получены лицензии на предоставление полного спектра услуг связи по всей России. Подключены первые корпоративные клиенты на объектах коммерческой недвижимости в Москве.",
    ),
    array(
        "img" => "/images/content/slider/2.jpg",
        "imgTablet" => "/images/content/slider/2-tablet.jpg",
        "imgMobile" => "/images/content/slider/2-mobile.jpg",
        "title" => "2014",
        "sub" => "Центральный узел «ММТС-9»",
        "txt" => "Организован центральный узел сети телематических услуг и передачи данных в Москве на «ММТС-9». Подключен к сети первый бизнес центр в Москве – РАЙЦЕНТР, Электрозаводская 14.",
    ),
    array(
...
<div class="slider">
    <div class="container">
        <div class="container-inner slider__container">
            <div class="slider__wrap">
                <div class="slider__big">
                    <div class="slide-big">
                        <div class="slide-big__left">
                            <div class="slide-big__sub">Более</div>
                            <div class="slide-big__title">250</div>
                            <div class="slide-big__sub">бизнес объектов</div>
                        </div>
                        <div class="slide-big__right">
                            <div class="slide-big__txt">
                                В настоящее время мы обслуживаем более 250 бизнес объектов на
                                территории Москвы и Петербурга.
                            </div>
                            <? component("btn", array(
                        ...
                        <? foreach ($list as $i): ?>
                            <div class="slider__item slide">
                                <div class="slide__img">
                                    <picture>
                                        <source srcset="<?= $i["imgTablet"] ?>"
                                                media="(max-width: 767.98px)"/>
                                        <source srcset="<?= $i["imgTablet"] ?>"
                                                media="(max-width: 1439.98px)"/>
                                        <source srcset="<?= $i["img"] ?>"
                                                media="(max-width: 1919.98px)"/>
                                        <img src="<?= $i["img"] ?>" alt="lorem">
                                    </picture>
                                </div>
